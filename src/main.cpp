...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis Block:
        // CBlock(hash=0000010f7157cb4b8fc8, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=a9ebef8264, nTime=1426888776, nBits=1e0fffff, nNonce=280531, vtx=1, vchBlockSig=)
        //   Coinbase(hash=a9ebef8264, nTime=1426883984, ver=1, vin.size=1, vout.size=1, nLockTime=0)
