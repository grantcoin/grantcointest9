...
static const int64 PROOF_OF_WORK_BLOCKS = 1000; // total number of PoW blocks
...
static const uint256 hashGenesisBlockOfficial("0x0000000d7fbbe584ad417d8abe92516fe89e94b97a381c298c489e6b8e34aba0");
...
public:
    ...
    {
        // grantcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // grantcoin: get transaction coin age
...
public:
    ...
    // grantcoin: block signature - signed by coin base txout[0]'s owner
    ...
    // grantcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // grantcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // grantcoin: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // grantcoin: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // grantcoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // grantcoin: block index flags
    enum  
    {
