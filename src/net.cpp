...
{
    // Wait for IRC to get it first - disabled with grantcoin
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Grantcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seed", "seed.grantcoin.net"},
//    {"seedgrt", "seedgrt.grantcoin.net"},
//    {"tnseed", "tnseed.grantcoin.net"},
//    {"tnseedgrt", "tnseedgrt.grantcoin.net"},
};
...
void ThreadDNSAddressSeed2(void* parg)
{
    ...
    if (true /*!fTestNet*/)  // grantcoin enables dns seeding with testnet too
    {
...
bool BindListenPort(string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, sizeof(sockaddr)) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to port %d on this computer.  Grantcoin is probably already running."), ntohs(sockaddr.sin_port));
        else
